...
local function createModernMenu()
    ...
    walkToBallToggleLabel.Size = UDim2.new(0.7, 0, 1, 0)
    walkToBallToggleLabel.BackgroundTransparency = 1
    walkToBallToggleLabel.Text = "Follow the ball"
    ...
    walkToBallToggleButton.Position = UDim2.new(1, -50, 0.5, -12)
    ...
    walkDistanceBox.Position = UDim2.new(0.75, -5, 0.15, 0)
    ...
    antiAfkButton.BackgroundColor3 = Color3.fromRGB(80, 80, 100)
    antiAfkButton.Text = "Anti-Afk - Already Running"
    antiAfkButton.TextColor3 = Color3.fromRGB(200, 200, 200)
    antiAfkButton.TextSize = 14
    antiAfkButton.Font = Enum.Font.Gotham
    antiAfkButton.Parent = combatContent

    local antiAfkCorner = Instance.new("UICorner")
    antiAfkCorner.CornerRadius = UDim.new(0, 4)
